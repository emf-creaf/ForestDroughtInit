...
for(i in 1:nrow(comarques)) {
  ...
  out_sf <- paste0("data/counties_",res,"m/medfateland_", county_code, "_sf_", res,"m.rds")
  output_tif <- paste0("data/counties_", res, "m/medfateland_", county_code, "_raster_",res,"m.tif")
